# -*- coding: utf-8 -*-
"""
Created on Thu Jun  6 16:18:45 2019
...
# calculate portfolio return based on the computed weights
def portfolio_return(weights, avg_rets):
    return sum(avg_rets *  weights)

# calculate portfolio vol based on the computed weights
def portfolio_vol(weights, cov_mat):
    return cov_mat.dot(weights).dot(weights)
